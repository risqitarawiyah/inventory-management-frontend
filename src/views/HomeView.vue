...
<template>
    <div class="home-view d-flex flex-column align-items-center justify-content-center min-vh-100 bg-custom text-white">
        <div class="text-center mb-4 welcome-text">
            ...
            <p class="lead mb-4">A powerful platform to efficiently manage your inventory and streamline operations.</p>
        </div>
...
<script>
import Login from "@/components/auth/LoginLogin.vue";
import Register from "@/components/auth/RegisterRes.vue";
export default {
    components: {
        Login,
        Register,
