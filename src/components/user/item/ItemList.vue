                ...
                <tbody>
                    <tr v-for="item in items" :key="item.id">
                        ...
                        <td class="action-buttons">
                            <button class="borrow-btn" @click="borrowItem(item)">Pinjam</button>
                        </td>
                    </tr>
                </tbody>
            </table>
        </div>
        <AllModal :visible="showForm" @close="cancelBorrowForm">
            <ItemForm :item="selectedItem" @submit="handleBorrow" @cancel="cancelBorrowForm" />
        </AllModal>
    </div>
</template>
